class AddPainAssessmentToSubmission < ActiveRecord::Migration[5.0]
  def change
    ...
    # Score 0
    add_column :submissions, :flacc_scale_face_0, :json
    add_column :submissions, :flacc_scale_legs_0, :json
    add_column :submissions, :flacc_scale_activity_0, :json
    add_column :submissions, :flacc_scale_cry_0, :json
    add_column :submissions, :flacc_scale_consolability_0, :json
    # Score 1
    ...
    # CPOT Scoring
    # Score 0
    add_column :submissions, :cpot_score_facial_expression_0, :json
    add_column :submissions, :cpot_score_body_movements_0, :json
    add_column :submissions, :cpot_score_ventilator_compliance_0, :json
    add_column :submissions, :cpot_score_vocalization_0, :json
    add_column :submissions, :cpot_score_muscle_tension_0, :json
    # Score 1
    add_column :submissions, :cpot_score_facial_expression_1, :json
    add_column :submissions, :cpot_score_body_movements_1, :json
    add_column :submissions, :cpot_score_ventilator_compliance_1, :json
    add_column :submissions, :cpot_score_vocalization_1, :json
    add_column :submissions, :cpot_score_muscle_tension_1, :json
    # Score 2
    add_column :submissions, :cpot_score_facial_expression_2, :json
    add_column :submissions, :cpot_score_body_movements_2, :json
    add_column :submissions, :cpot_score_ventilator_compliance_2, :json
    add_column :submissions, :cpot_score_vocalization_2, :json
    add_column :submissions, :cpot_score_muscle_tension_2, :json
    # Total Score
