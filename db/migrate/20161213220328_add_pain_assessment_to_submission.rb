class AddPainAssessmentToSubmission < ActiveRecord::Migration[5.0]
  def change
    ...
    # Score 0
    add_column :submissions, :flacc_scale_face_0, :boolean, :default => nil
    add_column :submissions, :flacc_scale_legs_0, :boolean, :default => nil
    add_column :submissions, :flacc_scale_activity_0, :boolean, :default => nil
    add_column :submissions, :flacc_scale_cry_0, :boolean, :default => nil
    add_column :submissions, :flacc_scale_consolability_0, :boolean, :default => nil
    # Score 1
    add_column :submissions, :flacc_scale_face_1, :boolean, :default => nil
    add_column :submissions, :flacc_scale_legs_1, :boolean, :default => nil
    add_column :submissions, :flacc_scale_activity_1, :boolean, :default => nil
    add_column :submissions, :flacc_scale_cry_1, :boolean, :default => nil
    add_column :submissions, :flacc_scale_consolability_1, :boolean, :default => nil
    # Score 2
    add_column :submissions, :flacc_scale_face_2, :boolean, :default => nil
    add_column :submissions, :flacc_scale_legs_2, :boolean, :default => nil
    add_column :submissions, :flacc_scale_activity_2, :boolean, :default => nil
    add_column :submissions, :flacc_scale_cry_2, :boolean, :default => nil
    add_column :submissions, :flacc_scale_consolability_2, :boolean, :default => nil
    # Total Score
