  ...
  private
    ...
    def submission_params
      params.require(:submission).permit(
        ...
        :each_risk_factor_represents_one_point,
        :each_risk_factor_represents_two_point,
        :each_risk_factor_represents_three_point,
        :each_risk_factor_represents_five_point,
        ...
        medications:[],
        heart_sounds: [],
        risk_factor_one_values:[],
        risk_factor_two_values:[],
        risk_factor_three_values:[],
        risk_factor_five_values:[],
